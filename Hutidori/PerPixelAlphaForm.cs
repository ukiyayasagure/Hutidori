...
namespace Hutidori {
    ...
    class PerPixelAlphaForm : Form,PreviewForm {
        ...
        private void PerPixelAlphaForm_MouseDown(object sender, MouseEventArgs e) {
        ...
        private void PerPixelAlphaForm_MouseMove(object sender, MouseEventArgs e) {
            if ((e.Button & MouseButtons.Left) != 0) {
        ...
        */
        ...
        private void InitializeComponent() {
            ...
            this.Text = "プレビュー";
            this.TopMost = true;
            this.DoubleClick += new System.EventHandler(this.PerPixelAlphaForm_DoubleClick);
            this.MouseDown += new System.Windows.Forms.MouseEventHandler(this.PerPixelAlphaForm_MouseDown);
            this.FormClosing += new System.Windows.Forms.FormClosingEventHandler(this.PerPixelAlphaForm_FormClosing);
            this.MouseMove += new System.Windows.Forms.MouseEventHandler(this.PerPixelAlphaForm_MouseMove);
            this.ResumeLayout(false);

        }

        private void PerPixelAlphaForm_DoubleClick(object sender, EventArgs e) {
            this.Visible = false;

        }

        private void PerPixelAlphaForm_FormClosing(object sender, FormClosingEventArgs e) {
            this.Visible = false;
            e.Cancel = true;
        }
